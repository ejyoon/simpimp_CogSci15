...
The current work also sheds light on children's moment-to-moment processing of implicatures. Against claims that children are not able to compute SI's during online language comprehension (e.g., \citeNP{huang2009semantic}), the current work suggests another possibility: implicature computation is delayed compared to interpretations of unambiguous utterances; however, with contextual access to scales relevant to implicature computation, children as young as 3 years could spontaneously generate implicature inferences. 
