...
% Upon hearing a term such as ``some'', children may not be able to generate the relevant scalar alternative (``all'') to negate, even if they know that there are alternatives to be negated. 
